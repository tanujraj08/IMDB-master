...
import com.tanuj.imdb.MainActivity;
import com.tanuj.imdb.MovieDetails;
...
public class CallWebService extends AsyncTask<String, Void, String> {
    ...
    public CallWebService(Context context, String url, FormEncodingBuilder formBody, CommonUtilities.SERVICE_TYPE Servicetype, MainActivity onWebServiceResultListener) {
